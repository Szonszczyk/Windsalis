...
class Menus {
	...
	msToTime(liczba) { // 
		if(liczba<0) 
		return `mniej niż 0 sekund`;
		if(liczba == 0) 
			return `równe 0 sekund`;
		let dni = Math.floor(liczba / 86400000);
		liczba = liczba % 86400000;
		let godziny = Math.floor(liczba / 3600000);
		liczba = liczba % 3600000;
		let minuty = Math.floor(liczba / 60000);
		liczba=liczba % 60000;
		let sekundy = Math.floor(liczba / 1000);
		let dniPL = {1:"dzień"};
		let godzPL = {1:"godzina",2:"godziny",3:"godziny",4:"godziny",22:"godziny",23:"godziny",24:"godziny",32:"godziny",33:"godziny",34:"godziny",42:"godziny",43:"godziny",44:"godziny",52:"godziny",53:"godziny",54:"godziny"};
		let minPL = {1:"minuta",2:"minuty",3:"minuty",4:"minuty",22:"minuty",23:"minuty",24:"minuty",32:"minuty",33:"minuty",34:"minuty",42:"minuty",43:"minuty",44:"minuty",52:"minuty",53:"minuty",54:"minuty"};
		let sekPL = {1:"sekunda",2:"sekundy",3:"sekundy",4:"sekundy",22:"sekundy",23:"sekundy",24:"sekundy",32:"sekundy",33:"sekundy",34:"sekundy",42:"sekundy",43:"sekundy",44:"sekundy",52:"sekundy",53:"sekundy",54:"sekundy"};
		let text = "";
	...
	ReturnTrackTime(liczba) {
		...
		if(liczba>3600000)
			return ` >1h `;
		liczba=liczba%3600000;
		var minuty = Math.floor(liczba/60000);
		liczba=liczba%60000;
		var sekundy = Math.floor(liczba/1000);
	...
	YoutubeVideosEmbed(playlist, text) {
		...
		let fields = [];
		let reaction = {0:"1⃣",1:"2⃣",2:"3⃣",3:"4⃣",4:"5⃣"};
		for(var i = 0; i < (playlist.length > 5 ? 5 : playlist.length); i++) { 
			embed.addFields({
...
Pozostało: ${this.msToTime(dispatcher.current.info.length - pp)}\n   ‌ `} `
        ...
        for(var i = 0; i < (q.length > 2 ? 2 : q.length); i++) {
